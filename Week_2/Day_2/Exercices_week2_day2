...
def describe_city(city, country="Unknown"):
    print(f"You typed the city of {city}\nYou typed the country {country}")
...
def number(n):
    ...
    if generated_number == n:
        print("Congratulation, both numbers matchs")
    else:
        print(f"Unfortunaly your number {n} does not match the following generated number: {generated_number}")
...
def make_shirt(size, text):
    print(f"This is a size {size} shirt, with the following message:\n{text}")
...
make_shirt()
make_shirt("Medium")
make_shirt("Extra-Large", "I love React!")
make_shirt(size="ExtraSmall", text="Your are too fat for that one..")
...
magicians_list = ['Harry Houdini', 'David Blaine', 'Criss Angel']
def show_magicians(magicians_list):
    for m in magicians_list:
        print(m)
def make_great(magicians_list):
    for n in range(len(magicians_list)):
        magicians_list[n] = magicians_list[n] + " the Great"
